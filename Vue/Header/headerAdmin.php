...
<header class="headersite" style="z-index:100">
	<table id = "barreAccueil" class="caption">
		...
		<tr style="background-color:rgba(0,0,0,0.5)">
			...
			<td id="itemAdministration" class="menuItem"><a href="action.php?action=goToAdministration&focus1=itemAdministration&focus2=&" style="text-decoration:none;color:inherit;">Administration</a></td>
