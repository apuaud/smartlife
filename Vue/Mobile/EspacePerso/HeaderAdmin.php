				 ...
				 <section class="MenuHeader">
					<table>
						<tr class="tableHeader">
							...
							<td class="ongletHeader"> <a class="lienheader" href="http://localhost:8888/SmartLife/admin.php">Paramètres</a></td>
							<td class="ongletHeader"> <a class="lienheader" href="http://localhost:8888/SmartLife/admin.php">Administration</a></td>
						</tr>
					</table>
