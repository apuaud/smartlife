	...
	<html>
		...
		include_once("../../analyticstracking.php"); ?>
			...
			<table class="listepiece manontable">
				...
				{
					echo "<td class='manon'><div class='textbox'><span><a href='http://localhost:8888/SmartLife/Vue/Desktop/EspacePerso/account.php?maison="
					. $donnees['id'] . "'>" . $donnees['nom'] . "</a></span></div></td>";
				} ?>
					<td class="manon"><div class="textbox">
						<span><a href="http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=goToAjoutMaison">+</a></span>
					</td>
				</tr>
			</table>
		...
		<?php if(isset($_GET['maison'])){
			echo "<table class='manon'><tr>";
				...
				echo "<td class='manon'><div class='textbox'>
					<span><a href='http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=goToAjoutPiece?maison=" . $_GET['maison'] . "'>+</a></span>
					</td></tr></table>";
			} ?>
