		...
		<div class="container" id="accueil" >
			...
			<table id = "barreAccueil" class="caption">
				<tr>
					...
					<td id='itemAide'class="menuItem"><a href="http://puaud.eu/app/Controleur/action.php?device=Desktop&action=goToSupport" style="text-decoration:none;color:inherit;">Help</a></td>
				</tr>
				<tr id="ligneServices">
					<td></td>
