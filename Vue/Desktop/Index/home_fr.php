...
<html>
	...
	<body class="margin0" onload="onLoadFunction()">
		<div id="formulaire">
			<form action="http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=connexion" method="post">
			<table id="login" align="center">
				...
				<tr>
					<td id='itemLostPassword'  align="center"><a href="http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=goToOublieMotDePasse" style="color:white" >Mot de passe oublié ?</td>
				</tr>
				</form>
				<tr>
		...
		<p class="langueselect">
			<a href="http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=goToLanguefr">
				<button class="buttonlangue" name="fr">
					<img src="http://www.oneturf.fr/images/fr.gif" alt="fr" style="height:15px;max-width:auto;" />
			</a>
				</button> |
				<a href="http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=goToLangueen">
		...
		<div class="container" id="accueil" >
			...
			<table id = "barreAccueil" class="caption">
				<tr>
					...
					<td id='itemAide'class="menuItem"><a href="http://localhost:8888/SmartLife/Controleur/action.php?device=Desktop&action=goToSupport" style="text-decoration:none;color:inherit;">Support</a></td>
				</tr>
				<tr id="ligneServices">
					<td></td>
