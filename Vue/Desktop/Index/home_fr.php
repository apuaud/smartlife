...
<html>
	...
	<body class="margin0" onload="onLoadFunction()">
		<div id="formulaire">
			<form action="http://puaud.eu/app/Controleur/action.php?device=Desktop&action=connexion" method="post">
			<table id="login" align="center">
				...
				<tr>
					<td id='itemLostPassword'  align="center"><a href="http://puaud.eu/app/Controleur/action.php?device=Desktop&action=goToOublieMotDePasse" style="color:white" >Mot de passe oublié ?</td>
				</tr>
				</form>
				<tr>
		...
		<p class="langueselect">
			<a href="http://puaud.eu/app/Controleur/action.php?device=Desktop&action=goToLanguefr">
				<button class="buttonlangue" name="fr">
					<img src="http://www.oneturf.fr/images/fr.gif" alt="fr" style="height:15px;max-width:auto;" />
			</a>
				</button> |
				<a href="http://puaud.eu/app/Controleur/action.php?device=Desktop&action=goToLangueen">
		...
		<div class="container" id="accueil" >
			...
			<table id = "barreAccueil" class="caption">
				<tr>
					...
					<td id='itemAide'class="menuItem"><a href="http://puaud.eu/app/Controleur/action.php?device=Desktop&action=goToSupport" style="text-decoration:none;color:inherit;">Support</a></td>
				</tr>
				<tr id="ligneServices">
					<td></td>
		...
		<script type="text/javascript" src="http://puaud.eu/app/Vue/Desktop/Index/firstPage.js"></script>
