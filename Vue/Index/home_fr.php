		...
		<div class="container" id="accueil" >
			...
			<table id = "barreAccueil" class="caption">
				<tr>
					...
					<td id='itemAide'class="menuItem"><a href="Controleur/action.php?action=goToSupport&focus1=itemSupport&focus2=&" style="text-decoration:none;color:inherit;">Support</a></td>
				</tr>
				<tr id="ligneServices">
					<td></td>
