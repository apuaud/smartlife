...
<div class="container" id="accueil" >
	...
	<table id = "barreAccueil" class="caption" style="position:fixed ">
		<tr>
			<td id="itemAccueil" class="menuItem"><a href="http://puaud.eu/appmvc/" style="text-decoration:none;color:inherit;">Home</a></td>
			<td id="itemPresentation" class="menuItem">Services</td>
			<td id='itemLogo' ></td>
			<td id='itemAccount'class="menuItem" onclick="displayFormulaire()">Account</td>
			<td id='itemAide'class="menuItem" ><a href="http://puaud.eu/appmvc/Controleur/contact.php" style="text-decoration:none;color:inherit;">Help</a></td>
		</tr>
		<tr id="ligneServices">
			<td></td>
