...
<p id="logoContainer"><img align="middle"id="logo2" src="http://image.noelshack.com/fichiers/2017/13/1490602674-accueil-logo.png"></p>
	<table id = "barreAccueil" class="caption" style="position:fixed ">
		<tr>
			<td id="itemAccueil" class="menuItem"><a href="http://puaud.eu/appmvc/" style="text-decoration:none;color:inherit;">Accueil</a></td>
			...
			<td id='itemAide'class="menuItem" ><a href="http://puaud.eu/appmvc/Controleur/contact.php" style="text-decoration:none;color:inherit;">Support</a></td>
		</tr>
		<tr id="ligneServices">
			<td></td>
